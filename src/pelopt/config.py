...
DEFAULT_TFIM = datetime.now(TZ_SAO_PAULO).replace(microsecond=0, second=0, minute=0)
DEFAULT_TINI = DEFAULT_TFIM - relativedelta(days=547).replace(microsecond=0, second=0, minute=0)
